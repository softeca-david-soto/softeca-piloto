    ...
    <form action="{{ route('clientes.store') }}" method="POST" class="space-y-4" enctype="multipart/form-data">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <flux:input name="name" placeholder="David Soto" value="{{ old('name') }}"></flux:input>
            </div>

            <div>
                <flux:label>Email <span class="text-red-500 font-semibold">*</span></flux:label>
                <flux:input name="email" placeholder="davidsoto@mail.es" value="{{ old('email') }}"></flux:input>
            </div>

            <div>
                <flux:label>Teléfono <span class="text-red-500 font-semibold">*</span></flux:label>
                <flux:input name="phone" placeholder="645251575" value="{{ old('phone') }}"></flux:input>
            </div>
            ...
            <flux:input name="zipcode" placeholder="09007" label="Código Postal" value="{{ old('zipcode') }}"></flux:input>
